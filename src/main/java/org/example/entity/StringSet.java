...
public class StringSet {
    ...
    public static TreeSet<String> findUniqueWords() {
        String text = "Carroll began writing the manuscript of the story the next day, although that earliest version is lost. "
                ...
                + "were more appealing to its audiences. He subsequently approached John Tenniel to reinterpret Carrolls visions "
                + "through his own artistic eye, telling him that the story had been well liked by the children. "
                + "Carroll began planning a print edition of the Alice story in 1863. "
                + "He wrote on 9 May 1863 that MacDonalds family had suggested he publish Alice. "
                + "A diary entry for 2 July says that he received a specimen page of the print edition around that date. "
                + "On 26 November 1864 Carroll gave Alice the manuscript of Alices Adventures Under Ground with illustrations "
                + "by Carroll dedicating it as a Christmas Gift to a Dear Child in Memory of a Summers Day. "
                + "The published version of Alices Adventures in Wonderland is about twice the length of Alices Adventures "
